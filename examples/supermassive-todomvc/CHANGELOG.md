...
<!-- This log was last generated on Thu, 03 Apr 2025 09:53:17 GMT and should not be manually modified. -->

<!-- Start content -->

## 1.0.1-1

Thu, 03 Apr 2025 09:53:17 GMT

### Changes

- update license (pavelglac@gmail.com)
...
- Bump @graphitation/apollo-react-relay-duct-tape to v1.2.2
- Bump @graphitation/apollo-react-relay-duct-tape-compiler to v1.5.4
- Bump @graphitation/supermassive to v3.5.3
- Bump @graphitation/ts-transform-graphql-js-tag to v1.4.1
- Bump @graphitation/webpack-loader to v1.0.6
...
- Bump @graphitation/apollo-react-relay-duct-tape to v1.2.1
...
- Bump @graphitation/apollo-react-relay-duct-tape to v1.2.0
...
- Bump @graphitation/webpack-loader to v1.0.4
...
- Bump @graphitation/ts-transform-graphql-js-tag to v1.3.0
...
- Bump @graphitation/ts-transform-graphql-js-tag to v1.2.0
