// NOTE: This version does NOT remove the fragments.
...
function fragmentSpreadVisitor(cache: FragmentVisitorCache): FragmentVisitor {
  return function visitFragmentSpread(
    this: any,
    fragmentSpread: FragmentSpread,
  ) {
    ...
    cache.set(fragmentSpread, traverseResult as FragmentSpread);
    return traverseResult;
  };
}
