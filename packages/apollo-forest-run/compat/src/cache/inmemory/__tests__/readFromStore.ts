...
describe('reading from the store', () => {
  ...
  it('distinguishes between missing @client and non-@client fields', () => {
    ...
    // ForestRun: does not detect missing leaf fields (this is expensive)
    ...
    // ForestRun: does not detect missing leaf fields (this is expensive). Assuming "read" policies do not return objects with missing fields.
