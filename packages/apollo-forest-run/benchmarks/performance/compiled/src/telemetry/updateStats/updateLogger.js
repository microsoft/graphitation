...
class UpdateLogger {
    ...
    copyParentChunkStats(chunk, draft) {
        var _a;
        const isDraft = !!draft;
        this.recordChunkCopy(chunk, (_a = this.currentUpdate) === null || _a === void 0 ? void 0 : _a.updateAscendantStats, isDraft);
    }
    copyChunkStats(chunk, draft) {
        var _a;
        const isDraft = !!draft;
        this.recordChunkCopy(chunk, (_a = this.currentUpdate) === null || _a === void 0 ? void 0 : _a.updateStats, isDraft);
    }
