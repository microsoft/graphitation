...
function createDraft(operation, possibleSelections, ref, typeName, source, incompleteValues) {
    ...
    source !== null && source !== void 0 ? source : (source = !isRoot ||
...
function hydrateDraft(env, draft, chunkProvider, chunkMatcher, enterObject) {
    ...
    if (!rootChunk) {
        (_a = draft.data) !== null && _a !== void 0 ? _a : (draft.data = {});
        (_b = draft.missingFields) !== null && _b !== void 0 ? _b : (draft.missingFields = getMissingDraftFields(draft));
    ...
    const { data, incompleteValues } = (0, execute_1.execute)(draft.operation, draft.possibleSelections, rootChunk, draft, {
        ...
        enterObject(model, selection, firstVisit, output) {
            ...
            if (model.key !== false) {
                ...
                (_a = env.keyMap) === null || _a === void 0 ? void 0 : _a.set(output, model.key);
    ...
    if (incompleteValues === null || incompleteValues === void 0 ? void 0 : incompleteValues.size) {
...
function getMissingDraftFields(draft) {
    ...
    if (incompleteValues) {
        return (incompleteValues === null || incompleteValues === void 0 ? void 0 : incompleteValues.size)
...
function isRecyclable(chunk) {
    ...
    if (((_a = chunk.missingFields) === null || _a === void 0 ? void 0 : _a.size) ||
        ((_b = chunk.partialFields) === null || _b === void 0 ? void 0 : _b.size) ||
