...
function ascendFromChunk(env, from, visit) {
    ...
    while (parentInfo === null || parentInfo === void 0 ? void 0 : parentInfo.parent) {
        const step = Predicates.isParentListRef(parentInfo)
            ? parentInfo.index
            : parentInfo.field;
        if ((visit === null || visit === void 0 ? void 0 : visit(value, parentInfo.parent, step)) === false) {
            break;
        }
...
function descendToChunk(env, from, to, visit) {
    ...
    while ((parentInfo === null || parentInfo === void 0 ? void 0 : parentInfo.parent) &&
        (parentInfo === null || parentInfo === void 0 ? void 0 : parentInfo.parent.possibleSelections) !== from.possibleSelections) {
    ...
    while (step !== undefined) {
        ...
        if ((visit === null || visit === void 0 ? void 0 : visit(value, parent, step)) === false) {
            break;
        }
...
function retrieveEmbeddedValue(env, source, ref) {
    ...
    let parentRef = ref[0];
    while ((parentRef === null || parentRef === void 0 ? void 0 : parentRef.parent) &&
