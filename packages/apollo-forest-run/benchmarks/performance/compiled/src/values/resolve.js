...
function getNormalizedField(chunk, field) {
    var _a, _b;
    return (_b = (_a = chunk.selection.normalizedFields) === null || _a === void 0 ? void 0 : _a.get(field)) !== null && _b !== void 0 ? _b : field.name;
}
function resolveFieldValue(chunk, fieldEntry) {
    var _a;
    const aliases = (_a = resolveMatchingFieldAliases(chunk, fieldEntry)) !== null && _a !== void 0 ? _a : EMPTY_ARRAY;
    if (!aliases.length) {
...
function resolveFieldChunk(chunk, field) {
    ...
    if (!field.selection) {
        ...
        if (((_a = chunk.missingFields) === null || _a === void 0 ? void 0 : _a.size) && chunk.missingFields.has(field)) {
...
function resolveMatchingFieldAliases(chunk, fieldEntry) {
    ...
    const aliases = (_a = resolveFieldAliases(chunk, Descriptor.getFieldName(fieldEntry))) !== null && _a !== void 0 ? _a : EMPTY_ARRAY;
    ...
    return (matchingAliases === null || matchingAliases === void 0 ? void 0 : matchingAliases.length) !== (aliases === null || aliases === void 0 ? void 0 : aliases.length)
        ? matchingAliases !== null && matchingAliases !== void 0 ? matchingAliases : EMPTY_ARRAY
        : aliases;
}
function aggregateFieldNames(object) {
    ...
    if (object.chunks.length === 1 && !((_a = object.nullChunks) === null || _a === void 0 ? void 0 : _a.length)) {
...
function aggregateFieldEntries(object, fieldName) {
    ...
    const parentChunks = (_b = (_a = object.fieldChunksDeduped) === null || _a === void 0 ? void 0 : _a.get(fieldName)) !== null && _b !== void 0 ? _b : object.chunks;
...
function aggregateFieldValue(parent, fieldEntry) {
    ...
    const parentChunks = (_b = (_a = parent.fieldChunksDeduped) === null || _a === void 0 ? void 0 : _a.get(fieldName)) !== null && _b !== void 0 ? _b : parent.chunks;
    if (parentChunks.length === 1 && !((_c = parent.nullChunks) === null || _c === void 0 ? void 0 : _c.length)) {
