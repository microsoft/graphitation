...
function updateTree(env, base, differenceMap, getNodeChunks) {
    ...
    (0, assert_1.assert)((rootChunks === null || rootChunks === void 0 ? void 0 : rootChunks.length) === 1);
    ...
    for (const chunk of chunkQueue) {
        ...
        statsLogger === null || statsLogger === void 0 ? void 0 : statsLogger.startChunkUpdate(chunk);
        ...
        if (chunkRef.parent === null && chunkRef.detached) {
            Object.assign(chunk, {
                source: result.draft,
                missingFields: (_a = result === null || result === void 0 ? void 0 : result.missingFields) === null || _a === void 0 ? void 0 : _a.get(result.draft),
            });
            continue;
        }
        createSourceCopiesUpToRoot(context, base, chunk);
        statsLogger === null || statsLogger === void 0 ? void 0 : statsLogger.finishChunkUpdate();
    }
    if (!changedNodes.size) {
        return {
            ...
            changedNodes,
            affectedNodes,
            stats: statsLogger === null || statsLogger === void 0 ? void 0 : statsLogger.getStats(operation.debugName),
        };
    }
    ...
    for (const [source, draft] of drafts.entries()) {
        ...
        if ((missing === null || missing === void 0 ? void 0 : missing.size) && (0, values_1.isSourceObject)(draft)) {
            missingFields.set(draft, missing);
        }
        // ApolloCompat
        const key = (_b = env.keyMap) === null || _b === void 0 ? void 0 : _b.get(source);
        if (key && (0, values_1.isSourceObject)(draft)) {
            (_c = env.keyMap) === null || _c === void 0 ? void 0 : _c.set(draft, key);
        }
    }
...
function completeObject(env, base, getNodeChunks, object, possibleSelections, operation) {
    ...
    if (!((_a = draft.incompleteValues) === null || _a === void 0 ? void 0 : _a.size)) {
        return draft;
    }
    return (0, values_1.hydrateDraft)(env, draft, function getSourceChunks(ref) {
        ...
        return (_a = (getNodeChunks ? getNodeChunks(key) : base.nodes.get(key))) !== null && _a !== void 0 ? _a : [];
    });
}
function createSourceCopiesUpToRoot(context, tree, from, isRootCall = true, isIndirectlyAffected = false) {
    ...
    if (!parent || (0, values_1.isRootRef)(parent)) {
        ...
        statsLogger === null || statsLogger === void 0 ? void 0 : statsLogger.copyParentChunkStats(from, draft);
        if (!draft) {
            draft = { ...data };
