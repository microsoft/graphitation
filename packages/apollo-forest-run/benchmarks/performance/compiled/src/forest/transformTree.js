...
function transformChunkFields(env, treeState, chunk, transformer) {
    ...
    for (const fieldName of fieldQueue) {
        ...
        for (const fieldInfo of aliases !== null && aliases !== void 0 ? aliases : EMPTY_ARRAY) {
            ...
            const valueDifference = transformer.transformField(chunk, fieldInfo, (0, values_1.resolveFieldChunk)(chunk, fieldInfo), fieldDifference === null || fieldDifference === void 0 ? void 0 : fieldDifference.state);
            if (valueDifference && Difference.isDirty(valueDifference)) {
                chunkDiff !== null && chunkDiff !== void 0 ? chunkDiff : (chunkDiff = addDifference(treeState, parentNode, chunk, Difference.createObjectDifference()));
                if (!fieldDifference) {
...
function collectChunks(tree, direction, filter) {
    ...
    for (const typeName of typeSet) {
        chunks.push(...((_a = tree.typeMap.get(typeName)) !== null && _a !== void 0 ? _a : EMPTY_ARRAY));
    }
    const nodes = (_b = filter.nodes) !== null && _b !== void 0 ? _b : tree.nodes.keys();
    for (const nodeKey of nodes) {
        for (const chunk of (_c = tree.nodes.get(nodeKey)) !== null && _c !== void 0 ? _c : EMPTY_ARRAY) {
...
function getEmbeddedChunkDifference(treeState, chunk, parentNode, parentNodeDifference) {
    ...
    (0, values_1.descendToChunk)(treeState, parentNode, chunk, (value, parent, step) => {
        ...
        if ((0, values_1.isObjectValue)(parent)) {
            ...
            valueDifference = fieldDifference === null || fieldDifference === void 0 ? void 0 : fieldDifference.state;
        }
        else {
            (0, assert_1.assert)(typeof step === "number" &&
...
function addEmbeddedChunkDifference(treeState, parentNode, parentNodeDifference, chunk, chunkDifference) {
    ...
    (0, values_1.descendToChunk)(treeState, parentNode, chunk, (value, parent, step) => {
        ...
        if ((0, values_1.isObjectValue)(parent)) {
            ...
            const field = (0, resolvedSelection_1.resolveNormalizedField)(parent.selection, step);
            const fieldDifference = (_a = Difference.getFieldDifference(parentDiff, field)) !== null && _a !== void 0 ? _a : Difference.addFieldDifference(parentDiff, field, value === chunk ? chunkDifference : createValueDifference(value));
            ...
            valueDifference =
                (_b = Difference.getListItemDifference(parentDiff, step)) !== null && _b !== void 0 ? _b : Difference.addListItemDifference(parentDiff, step, value === chunk ? chunkDifference : createValueDifference(value));
        }
        (0, assert_1.assert)(Difference.isObjectDifference(valueDifference) ||
            Difference.isCompositeListDifference(valueDifference));
...
function markParentNodeDirty(treeState, parentNode, chunk) {
    ...
    (0, values_1.descendToChunk)(treeState, parentNode, chunk, (value, parent, step) => {
        ...
        if ((0, values_1.isObjectValue)(parent)) {
            ...
            parentDifference = (_a = Difference.getFieldDifference(parentDifference, field)) === null || _a === void 0 ? void 0 : _a.state;
        }
        else {
            (0, assert_1.assert)(typeof step === "number" &&
                Difference.isCompositeListDifference(parentDifference));
