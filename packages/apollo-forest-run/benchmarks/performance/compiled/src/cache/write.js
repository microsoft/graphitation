...
function write(env, store, activeTransaction, options) {
    ...
    const writeData = typeof options.result === "object" && options.result !== null
        ? options.result
        : {};
    const rootNodeKey = (_a = options.dataId) !== null && _a !== void 0 ? _a : objectKey(writeData);
    ...
    if (rootNodeKey !== undefined && options.dataId) {
        keyMap === null || keyMap === void 0 ? void 0 : keyMap.set(writeData, rootNodeKey);
    }
    ...
    const existingData = existingResult === null || existingResult === void 0 ? void 0 : existingResult.result.data;
    // Safeguard: make sure previous state doesn't leak outside write operation
    (0, assert_1.assert)(!(existingResult === null || existingResult === void 0 ? void 0 : existingResult.prev));
    ...
    if (!descriptor_1.ROOT_NODES.includes(operationDescriptor.rootNodeKey)) {
        ...
        targetForest.extraRootIds.set(operationDescriptor.rootNodeKey, typeName !== null && typeName !== void 0 ? typeName : "");
        operationDescriptor.rootType = typeName !== null && typeName !== void 0 ? typeName : "";
    }
    ...
    const modifiedIncomingResult = (0, policies_1.applyMergePolicies)(env, (0, store_1.getEffectiveReadLayers)(store, targetForest, false), mergePolicies, incomingResult, (_b = options.overwrite) !== null && _b !== void 0 ? _b : false);
    ...
    return {
        ...
        updateStats: allUpdates.map((update) => { var _a; return (_a = update.stats) !== null && _a !== void 0 ? _a : null; }),
    };
}
...
function processDiffErrors(forest, model, difference) {
    ...
    for (const diffError of difference.errors) {
        if (diffError.kind === "MissingFields") {
            for (const baseChunkError of (_a = diffError.base) !== null && _a !== void 0 ? _a : EMPTY_ARRAY) {
                // Missing chunks
                const chunk = baseChunkError.chunk;
                (_b = chunk.missingFields) !== null && _b !== void 0 ? _b : (chunk.missingFields = new Set());
            ...
            for (const modelChunkError of (_c = diffError.model) !== null && _c !== void 0 ? _c : EMPTY_ARRAY) {
                // Missing chunks
                const chunk = modelChunkError.chunk;
                (_d = chunk.missingFields) !== null && _d !== void 0 ? _d : (chunk.missingFields = new Set());
...
function resolveExtraRootNodeType(env, store, operationDescriptor, data) {
    ...
    if ((0, descriptor_1.isFragmentDocument)(operationDescriptor.document)) {
        ...
        const typeName = fragmentDef === null || fragmentDef === void 0 ? void 0 : fragmentDef.typeCondition.name.value;
        if (!((_a = env.possibleTypes) === null || _a === void 0 ? void 0 : _a[typeName])) {
            return typeName;
        }
    }
    ...
    if (chunk === null || chunk === void 0 ? void 0 : chunk.type) {
        return chunk.type;
    }
    return undefined;
}
