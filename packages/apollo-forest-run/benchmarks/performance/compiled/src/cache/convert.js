...
function toGraphCompositeChunk(context, selections, apolloValue) {
    ...
    const recycled = findChunk === null || findChunk === void 0 ? void 0 : findChunk(apolloValue);
    if (recycled) {
        return recycled;
    }
    ...
    return Value.createObjectChunk(operation, selections, source, (_a = context.env.objectKey(source)) !== null && _a !== void 0 ? _a : false);
}
...
function inlineAllApolloReferences(context, possibleSelections, apolloValue) {
    ...
    const selection = (0, resolvedSelection_1.resolveSelection)(context.operation, possibleSelections, (_a = apolloValue.__typename) !== null && _a !== void 0 ? _a : null);
    for (const fieldName of (_b = selection.fieldsWithSelections) !== null && _b !== void 0 ? _b : EMPTY_ARRAY) {
        const aliases = selection.fields.get(fieldName);
        for (const alias of aliases !== null && aliases !== void 0 ? aliases : EMPTY_ARRAY) {
