...
function read(env, store, activeTransaction, options) {
    ...
    if (env.optimizeFragmentReads && (0, descriptor_1.isFragmentDocument)(options.query)) {
        ...
        if (chunk) {
            return {
                result: chunk.data,
                complete: !((_a = chunk.missingFields) === null || _a === void 0 ? void 0 : _a.size),
            };
        }
    }
...
function readOperation(env, store, activeTransaction, operationDescriptor, options) {
    ...
    const optimistic = (_a = activeTransaction === null || activeTransaction === void 0 ? void 0 : activeTransaction.forceOptimistic) !== null && _a !== void 0 ? _a : options.optimistic;
    ...
    (0, assert_1.assert)(!(outputTree === null || outputTree === void 0 ? void 0 : outputTree.prev));
    return readState;
}
function readFragment(env, store, activeTransaction, options) {
    var _a, _b;
    const id = (_b = (_a = options.id) !== null && _a !== void 0 ? _a : options.rootId) !== null && _b !== void 0 ? _b : "ROOT_QUERY";
    ...
    const chunkMatcher = (chunk) => {
        var _a, _b, _c, _d;
        if (((_a = chunk.missingFields) === null || _a === void 0 ? void 0 : _a.size) || ((_b = chunk.partialFields) === null || _b === void 0 ? void 0 : _b.size)) {
            return false;
        }
        const aliases = (_d = (_c = chunk.selection.spreads) === null || _c === void 0 ? void 0 : _c.get(fragment.name.value)) !== null && _d !== void 0 ? _d : EMPTY_ARRAY;
        return aliases.some((spread) => {
            var _a;
            return !((_a = chunk.selection.skippedSpreads) === null || _a === void 0 ? void 0 : _a.has(spread)) &&
                // Note: currently only spreads with @nonreactive directive are supported
                spread.__refs.some((ref) => {
                    var _a;
                    return (_a = ref.node.directives) === null || _a === void 0 ? void 0 : _a.some((d) => d.name.value === "nonreactive" &&
    ...
    for (const opId of ops !== null && ops !== void 0 ? ops : EMPTY_ARRAY) {
        ...
        if (!(nodeChunks === null || nodeChunks === void 0 ? void 0 : nodeChunks.length)) {
            continue;
        }
        const matchingChunk = nodeChunks === null || nodeChunks === void 0 ? void 0 : nodeChunks.find(chunkMatcher);
        if (matchingChunk) {
...
function normalizeRootLevelTypeName(tree) {
    ...
    const rootNode = (_a = tree.nodes.get(tree.rootNodeKey)) === null || _a === void 0 ? void 0 : _a[0];
    if (!rootNode || Object.isFrozen(rootNode.data)) {
        return;
    }
    if (rootNode.selection.fields.has("__typename")) {
        (_b = (_c = rootNode.data).__typename) !== null && _b !== void 0 ? _b : (_c.__typename = rootNode.type || tree.operation.rootType);
    }
...
function growOutputTree(env, store, forest, operation, optimistic, previous) {
    ...
    for (const ref of (_a = tree.danglingReferences) !== null && _a !== void 0 ? _a : EMPTY_ARRAY) {
...
function growDataTree(env, forest, operationDescriptor) {
    ...
    if (!rootDraft.data &&
        ...
        ((_a = rootDraft.selection.fields) === null || _a === void 0 ? void 0 : _a.size) === 1 &&
        rootDraft.selection.fields.has("__typename")) {
        rootDraft.data = {
            __typename: (_c = (_b = env.rootTypes) === null || _b === void 0 ? void 0 : _b.query) !== null && _c !== void 0 ? _c : "Query",
        };
    }
    const source = { data: (_d = rootDraft === null || rootDraft === void 0 ? void 0 : rootDraft.data) !== null && _d !== void 0 ? _d : {} };
...
function applyTransformations(env, inputTree, dataLayers, previous) {
    ...
    const dirtyNodes = (_a = previous === null || previous === void 0 ? void 0 : previous.dirtyNodes) !== null && _a !== void 0 ? _a : resolveAffectedOptimisticNodes(inputTree, dataLayers);
...
function indexReadPolicies(env, tree) {
    ...
    for (const typeName of typeNames) {
        ...
        if (!(chunks === null || chunks === void 0 ? void 0 : chunks.length) || !(fieldMap === null || fieldMap === void 0 ? void 0 : fieldMap.size)) {
            continue;
        }
...
function reportFirstMissingField(tree) {
    ...
    if ((0, values_1.isObjectValue)(chunk)) {
        (0, assert_1.assert)((_a = chunk.missingFields) === null || _a === void 0 ? void 0 : _a.size);
        ...
        (0, assert_1.assert)((_b = chunk.missingItems) === null || _b === void 0 ? void 0 : _b.size);
...
const isConditionallyEnabled = (directive, variables) => {
    var _a;
    const ifArgument = (_a = directive.arguments) === null || _a === void 0 ? void 0 : _a[0];
    if (!ifArgument) {
        return true;
    }
